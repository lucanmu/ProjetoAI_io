...
const SignUpForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Um email de ativação foi enviado. Verifique seu email.");
            setFormData({
                first_name: "",
                last_name: "",
                email: "",
                        ...
                        <div className="sc-login-box sc-register-box">
                            ...
                            <div className="row">
                                <div className="mb-3 col-md-6">
                                    ...
                                    <input type="text" className="form-control" id="first_name" name="first_name" placeholder="Digite seu primeiro nome" onChange={handleChange} value={formData.first_name} required />
                                </div>
                                <div className="mb-3 col-md-6">
                                    <label htmlFor="last_name" className="form-label">Último Nome</label>
                                    <input type="text" className="form-control" id="last_name" name="last_name" placeholder="Digite seu último nome" onChange={handleChange} value={formData.last_name} required />
                                </div>
                                <div className="mb-3 col-md-6">
                            ...
                            <div className="register-account d-flex align-items-center justify-content-between">
                                <input type="submit" value="Criar Conta" className="btn btn-primary" />
