...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('Logged in:', data); // Simulate navigation
            } else {
    ...
    return (
        <div className="sc-login-section sc-pt-40 sc-md-pb-70">
        <div className="row">
            <div className="col-md-8 offset-md-2">
               
                {isLoading && <p>Carregando...</p>}
                {message && <p>{message}</p>}
                <form className="sc-login-box" onSubmit={handleSubmit} method="POST">
                    ...
                    <div className="register-account d-flex align-items-center justify-content-between">
                        <div>Não possui uma conta?<Link className='primary-color' to="/signup"> Cadastre-se</Link></div>
                        <div><Link className='primary-color' to="/reset-password">Esqueci minha senha</Link></div>
